...
object DataBaseModule {
    ...
    fun buildDatabase(application: Application?): DataBase {
        return Room.databaseBuilder(application!!, DataBase::class.java, "myDB")
    ...
    @Singleton
    @Provides
    fun initQDao(dataBase: DataBase): QDao? {
        return dataBase.qDao()
    }

    @kotlin.jvm.JvmStatic
    @Singleton
    @Provides
    fun initHDao(dataBase: DataBase): HDao? {
        return dataBase.hDao()
    }

    @kotlin.jvm.JvmStatic
    @Singleton
    @Provides
    fun initADao(dataBase: DataBase): ADao? {
