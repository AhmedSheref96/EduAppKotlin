...
@Database(
    entities = [Aentity::class, Hentity::class, Qentity::class, PrayEntity::class],
    version = 13
)
abstract class DataBase : RoomDatabase() {
    abstract fun qDao(): QDao?
    abstract fun hDao(): HDao?
    ...
    companion object {
        ...
        fun getInstance(context: Context) {
            if (instance == null) {
                instance =
                    Room.databaseBuilder(context.applicationContext, DataBase::class.java, "myDB")
